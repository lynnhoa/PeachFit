...
.nav-icons{display:flex;align-items:flex-end;justify-content:space-around;height:48px;width:100%;padding:8px 4px 6px;}
.nav-safe{display:none;}
.nb{display:flex;flex-direction:column;align-items:center;gap:3px;background:none;border:none;cursor:pointer;padding:0 10px;font-family:'DM Sans',sans-serif;-webkit-appearance:none;flex:1;}

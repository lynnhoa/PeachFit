...
.nav{flex-shrink:0;background:white;border-top:1px solid ${P.roseLite};display:flex;align-items:flex-start;justify-content:space-around;padding:10px 4px max(env(safe-area-inset-bottom,0px),10px);z-index:100;min-height:64px;}
